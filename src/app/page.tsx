...
const CATEGORIES = {
  Steel: {
    products: [
      ...
      { name: "এমএস অ্যাঙ্গেল বার (৫০মিমি x ৫০মিমি)", specs: "ট্রাস ও ফ্রেম তৈরির জন্য মাইল্ড স্টিল অ্যাঙ্গেল", price: 88000, image: "https://images.unsplash.com/photo-1534224039826-c7a0dea0e66a?w=400&auto=format&fit=crop&q=60" },
      ...
      { name: "কোল্ড রোল্ড শিট কয়েল (১.২মিমি)", specs: "অটো ও হোম অ্যাপ্লায়েন্সের জন্য উন্নত ফিনিশের শিট", price: 120000, image: "https://images.unsplash.com/photo-1513694203232-719a280e022f?w=400&auto=format&fit=crop&q=60" },
      { name: "হট রোল্ড শিট কয়েল (৩.০মিমি)", specs: "শিল্প কাঠামোর উপযোগী হট রোল্ড শিট কয়েল", price: 105000, image: "https://images.unsplash.com/photo-1534224039826-c7a0dea0e66a?w=400&auto=format&fit=crop&q=60" },
      { name: "গ্যালভানাইজড ঢেউখেলানো টিন (০.৩৬মিমি)", specs: "কারখানার শেডের উপযোগী প্রিমিয়াম দস্তা প্রলেপযুক্ত টিন", price: 130000, image: "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=400&auto=format&fit=crop&q=60" },
      { name: "এইচ-বিম স্ট্রাকচারাল স্টিল (১৫০x১৫০)", specs: "ভারী সিভিল ইঞ্জিনিয়ারিং কাঠামোর জন্য এইচ-সেকশন স্টিল", price: 98000, image: "https://images.unsplash.com/photo-1513694203232-719a280e022f?w=400&auto=format&fit=crop&q=60" },
      { name: "আই-বিম স্ট্রাকচারাল স্টিল (২০০x১০০)", specs: "সেতু ও ক্রেন রানওয়ের জন্য স্ট্যান্ডার্ড আই-সেকশন", price: 97500, image: "https://images.unsplash.com/photo-1534224039826-c7a0dea0e66a?w=400&auto=format&fit=crop&q=60" },
      { name: "এমএস স্কয়ার পাইপ (৫০মিমি x ৫০মিমি)", specs: "কাঠামো নির্মাণের জন্য ফাঁপা স্কয়ার মেটাল টিউবিং", price: 92000, image: "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=400&auto=format&fit=crop&q=60" },
      { name: "এমএস রাউন্ড চ্যানেল (১০০মিমি)", specs: "ভারী যন্ত্রপাতির সাপোর্টের জন্য সি-চ্যানেল স্টিল", price: 91000, image: "https://images.unsplash.com/photo-1513694203232-719a280e022f?w=400&auto=format&fit=crop&q=60" },
      { name: "হাই টেনসিল পিসি ওয়্যার (৫মিমি)", specs: "বৈদ্যুতিক খুঁটি ও প্রিকাস্ট কাজের জন্য উচ্চ ক্ষমতার তার", price: 118000, image: "https://images.unsplash.com/photo-1534224039826-c7a0dea0e66a?w=400&auto=format&fit=crop&q=60" }
    ],
    unit: "Tons",
    minQty: 10,
  },
  Cement: {
    products: [
      ...
      { name: "লাফার্জ হোলসিম স্ট্রং স্ট্রাকচার (PCC)", specs: "ড্যাম্প-লক শিল্ড প্রযুক্তিসম্পন্ন শক্তিশালী সিমেন্ট", price: 515, image: "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=400&auto=format&fit=crop&q=60" },
      { name: "প্রিমিয়ার সিমেন্ট স্পেশাল (OPC)", specs: "সেতু ও ফ্লাইওভারের জন্য উচ্চ কার্যক্ষমতাসম্পন্ন সিমেন্ট", price: 525, image: "https://images.unsplash.com/photo-1590069261209-f8e9b8642343?w=400&auto=format&fit=crop&q=60" },
      { name: "ক্রাউন সিমেন্ট কনক্রিট (PCC)", specs: "কম হাইড্রেশন তাপ উৎপন্নকারী টেকসই কম্পোজিট সিমেন্ট", price: 500, image: "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=400&auto=format&fit=crop&q=60" },
      { name: "আকিজ সিমেন্ট স্ট্রং (OPC)", specs: "ভারী সিভিল ফাউন্ডেশনের জন্য প্রিমিয়াম খাঁটি ক্লিঙ্কার সিমেন্ট", price: 535, image: "https://images.unsplash.com/photo-1590069261209-f8e9b8642343?w=400&auto=format&fit=crop&q=60" },
      { name: "হাইডেলবার্গ স্ক্যান সিমেন্ট (PCC)", specs: "ছাদ ঢালাইয়ের জন্য নির্ভরযোগ্য স্ট্রাকচারাল কম্পোজিট সিমেন্ট", price: 520, image: "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=400&auto=format&fit=crop&q=60" },
      { name: "এমআই সিমেন্ট সুপার (PCC)", specs: "উচ্চ শক্তির ব্লক ও সাধারণ কাঠামোর জন্য স্ট্যান্ডার্ড সিমেন্ট", price: 510, image: "https://images.unsplash.com/photo-1590069261209-f8e9b8642343?w=400&auto=format&fit=crop&q=60" },
      { name: "ডায়মন্ড সিমেন্ট (PCC)", specs: "আঞ্চলিক দীর্ঘস্থায়ী কাঠামোর জন্য সাধারণ কম্পোজিট সিমেন্ট", price: 495, image: "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=400&auto=format&fit=crop&q=60" },
      { name: "কনফিডেন্স সিমেন্ট (OPC)", specs: "প্রিকাস্ট গার্ডার ও কলামের জন্য দ্রুত শক্ত হওয়া সিমেন্ট", price: 540, image: "https://images.unsplash.com/photo-1590069261209-f8e9b8642343?w=400&auto=format&fit=crop&q=60" },
      { name: "আনোয়ার সিমেন্ট স্পেশাল (PCC)", specs: "দীর্ঘস্থায়িত্বের জন্য উন্নত সিলিকা কণা সমৃদ্ধ সিমেন্ট", price: 505, image: "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=400&auto=format&fit=crop&q=60" },
      { name: "সেনা সিমেন্ট প্রিমিয়াম (PCC)", specs: "উপকূলীয় অঞ্চলের লোনা পানি প্রতিরোধী শক্তিশালী সিমেন্ট", price: 500, image: "https://images.unsplash.com/photo-1590069261209-f8e9b8642343?w=400&auto=format&fit=crop&q=60" },
      { name: "মংলা সিমেন্ট (PCC)", specs: "সাশ্রয়ী প্লাস্টারিং ও সাধারণ ইটের গাঁথুনির কম্পোজিট সিমেন্ট", price: 490, image: "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=400&auto=format&fit=crop&q=60" }
    ],
    unit: "Bags",
    minQty: 500,
  },
  Textile: {
    products: [
      { name: "১০০% কটন সুতা (৩০/১ কার্ডেড)", specs: "রপ্তানিযোগ্য নিট পোশাকের জন্য উপযোগী কার্ডেড সুতা", price: 420, image: "https://images.unsplash.com/photo-1606225457115-9b0de873c5db?w=400&auto=format&fit=crop&q=60" },
      { name: "পলিয়েস্টার সিঙ্গেল জার্সি ফ্যাব্রিক", specs: "অ্যাক্টিভওয়্যারের জন্য ডাইড নিট সিঙ্গেল জার্সি ফ্যাব্রিক (১৬০ GSM)", price: 380, image: "https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?w=400&auto=format&fit=crop&q=60" },
      { name: "কটন ক্যানভাস হেভি GSM", specs: "ব্যাগ ও কাজের পোশাক তৈরির উপযোগী টেকসই ক্যানভাস ফ্যাব্রিক", price: 650, image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&auto=format&fit=crop&q=60" },
      { name: "টিসি ফ্লিস ফ্যাব্রিক (ব্রাশড ব্যাক)", specs: "কোয়েটশার্ট ও হুডির জন্য সুতি-পলিয়েস্টার ব্লেন্ড ফ্যাব্রিক", price: 480, image: "https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?w=400&auto=format&fit=crop&q=60" },
      { name: "কটন রিব ফ্যাব্রিক (২x২ লাইক্রা)", specs: "পোশাকের কাফ ও কলারের জন্য স্প্যানডেক্স-ব্লেন্ডেড ফ্যাব্রিক", price: 520, image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&auto=format&fit=crop&q=60" },
      { name: "কটন পিক ফ্যাব্রিক (ল্যাকোস্ট)", specs: "ক্লাসিক পিক নিট ফ্যাব্রিক দিয়ে তৈরি পোলো শার্টের কাপর", price: 490, image: "https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?w=400&auto=format&fit=crop&q=60" },
      { name: "১০০% পলিয়েস্টার ইন্টারলক ফ্যাব্রিক", specs: "সাবলিমেশন প্রিন্ট ও স্পোর্টসওয়্যারের জন্য ফাইন গেজ ফ্যাব্রিক", price: 340, image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&auto=format&fit=crop&q=60" },
      { name: "কটন টুইল ফ্যাব্রিক (১০ আউন্স)", specs: "প্যান্ট ও জ্যাকেট তৈরির উপযোগী কোনাকুনি বুননের সুতি কাপড়", price: 580, image: "https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?w=400&auto=format&fit=crop&q=60" },
      { name: "ডেনিম ফ্যাব্রিক (১২ আউন্স ইন্ডিগো)", specs: "জিন্স তৈরির জন্য ক্লাসিক ইন্ডিগো ডাইড কটন ডেনিম", price: 720, image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&auto=format&fit=crop&q=60" },
      { name: "ভিসকোস স্প্যানডেক্স সিঙ্গেল জার্সি", specs: "নমনীয়তা ও ভালো ফিটিংসের জন্য স্প্যানডেক্স-মিশ্রিত ভিসকোস ফ্যাব্রিক", price: 560, image: "https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?w=400&auto=format&fit=crop&q=60" },
      { name: "নাইলন ট্যাফেটা ফ্যাব্রিক", specs: "উইন্ডব্রেকার ও জ্যাকেটের ভেতরের লাইনিংয়ের ওয়াটারপ্রুফ ফ্যাব্রিক", price: 290, image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&auto=format&fit=crop&q=60" },
      { name: "মেলাঞ্জ কটন সুতা (৩২/১ নিট)", specs: "ফ্যাশনেবল নিটওয়্যারের জন্য ডুয়াল-টোন ব্লেন্ডেড কটন সুতা", price: 460, image: "https://images.unsplash.com/photo-1606225457115-9b0de873c5db?w=400&auto=format&fit=crop&q=60" },
      { name: "অ্যাক্রিলিক সোয়েটার সুতা (২/২৮ এনএম)", specs: "সোয়েটার তৈরির উপযোগী উলের বিকল্প সিন্থেটিক সুতা", price: 390, image: "https://images.unsplash.com/photo-1606225457115-9b0de873c5db?w=400&auto=format&fit=crop&q=60" },
      { name: "সেলাই সুতা কোন (৪০/২)", specs: "গার্মেন্টস কারখানায় উচ্চ-গতির সেলাইয়ের উপযোগী পলিয়েস্টার সুতা", price: 85, image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&auto=format&fit=crop&q=60" },
      { name: "পলিয়েস্টার বোতাম (বাল্ক)", specs: "পোশাকের জন্য স্ট্যান্ডার্ড ৪-হোল বিশিষ্ট বোতামের বাল্ক বক্স", price: 45, image: "https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?w=400&auto=format&fit=crop&q=60" }
    ],
    unit: "Kgs",
    minQty: 1000,
  },
  Agro: {
    products: [
      { name: "নন-বাসমতি চাল (মিনিকেট)", specs: "পাইকারি ও খুচরা বিক্রির জন্য ডাবল পলিশড প্রিমিয়াম চাল", price: 62000, image: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=400&auto=format&fit=crop&q=60" },
      { name: "ইয়েলো মেজ/ভুট্টা ফিড গ্রেড", specs: "কম আর্দ্রতা সম্পন্ন পশুখাদ্য তৈরির ভুট্টার দানা", price: 32000, image: "https://images.unsplash.com/photo-1530595467537-0b5996c41f2d?w=400&auto=format&fit=crop&q=60" },
      { name: "প্রিমিয়াম কোয়ালিটি সয়ামিল", specs: "পোল্ট্রি ও ফিশ ফিডের জন্য উচ্চ প্রোটিন সমৃদ্ধ সয়াবিন খৈল", price: 68000, image: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=400&auto=format&fit=crop&q=60" },
      { name: "সরিষার খৈল", specs: "গবাদি পশুর সুষম পুষ্টির জন্য তেল নিষ্কাশিত প্রিমিয়াম খৈল", price: 42000, image: "https://images.unsplash.com/photo-1530595467537-0b5996c41f2d?w=400&auto=format&fit=crop&q=60" },
      { name: "গম ময়দা (আটা) বাল্ক", specs: "বাণিজ্যিক বেকারি ও ময়দা কলের জন্য উন্নত মানের আটা", price: 48000, image: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=400&auto=format&fit=crop&q=60" },
      { name: "সুজি বাল্ক", specs: "খাদ্য প্রক্রিয়াকরণ কারখানার জন্য হাই-গ্লুটেন গমের সুজি", price: 52000, image: "https://images.unsplash.com/photo-1530595467537-0b5996c41f2d?w=400&auto=format&fit=crop&q=60" },
      { name: "রাইস ব্র্যান অয়েল (ক্রুড)", specs: "ভোজ্যতেল রিফাইনারি কারখানার অপরিশোধিত তেল", price: 145000, image: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=400&auto=format&fit=crop&q=60" },
      { name: "মসুর ডাল", specs: "আমদানি করা উন্নত মানের পলিশড লাল মসুর ডাল", price: 110000, image: "https://images.unsplash.com/photo-1530595467537-0b5996c41f2d?w=400&auto=format&fit=crop&q=60" },
      { name: "ছোলা বুট বাল্ক", specs: "পাইকারি বাজারে বিতরণের জন্য শুকনো আস্ত কাঁচা ছোলা", price: 85000, image: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=400&auto=format&fit=crop&q=60" },
      { name: "ধনে বীজ আস্ত", specs: "ধনে গুঁড়া কারখানার উপযোগী রোদে শুকানো প্রিমিয়াম ধনে বীজ", price: 165000, image: "https://images.unsplash.com/photo-1530595467537-0b5996c41f2d?w=400&auto=format&fit=crop&q=60" },
      { name: "শুকনো আস্ত লাল মরিচ", specs: "মরিচের গুঁড়া তৈরির জন্য বোঁটাহীন শুকনো ঝাল লাল মরিচ", price: 280000, image: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=400&auto=format&fit=crop&q=60" },
      { name: "পরিশোধিত চিনি (বাল্ক)", specs: "শিল্পে ব্যবহারের উপযোগী ৫০ কেজি বস্তার পরিশোধিত চিনি", price: 125000, image: "https://images.unsplash.com/photo-1530595467537-0b5996c41f2d?w=400&auto=format&fit=crop&q=60" },
      { name: "ফিড গ্রেড ডাই-ক্যালসিয়াম ফসফেট", specs: "মুরগি ও গরুর খাদ্যের খনিজ ক্যালসিয়াম সাপ্লিমেন্ট", price: 72000, image: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=400&auto=format&fit=crop&q=60" },
      { name: "ফিশ মিল প্রোটিন কনসেন্ট্রেট", specs: "অ্যাকোয়া ফিড কারখানার জন্য বাষ্পে শুকানো মাছের গুঁড়া", price: 95000, image: "https://images.unsplash.com/photo-1530595467537-0b5996c41f2d?w=400&auto=format&fit=crop&q=60" },
      { name: "সাদা তিল বীজ", specs: "বেকারি ও বেকিং শিল্পের জন্য ধোয়া এবং বাছাই করা সাদা তিল", price: 180000, image: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=400&auto=format&fit=crop&q=60" }
    ],
    unit: "Tons",
    minQty: 15,
  },
  Chemicals: {
    products: [
      ...
      { name: "সাইট্রিক অ্যাসিড অ্যানহাইড্রাস", specs: "খাদ্য, পানীয় এবং ডিটারজেন্টের অম্লতা নিয়ন্ত্রক", price: 145, image: "https://images.unsplash.com/photo-1603126857599-f6e157fa2fe6?w=400&auto=format&fit=crop&q=60" },
      ...
      { name: "লিকুইড ক্লোরিন (সিলিন্ডার)", specs: "পানি শোধনাগারের জীবাণুনাশক সংকুচিত ক্লোরিন গ্যাস", price: 120, image: "https://images.unsplash.com/photo-1603126857599-f6e157fa2fe6?w=400&auto=format&fit=crop&q=60" },
  ...
  Packaging: {
    products: [
      ...
      { name: "ঢেউখেলানো শিট ৩-প্লাই", specs: "ডাই-কাট কার্টন তৈরিতে ব্যবহৃত ৩ স্তরের শক্ত শিট", price: 45000, image: "https://images.unsplash.com/photo-1512909006721-3d6018887383?w=400&auto=format&fit=crop&q=60" },
      { name: "ঢেউখেলানো শিট ৫-প্লাই", specs: "ভারী পণ্য দূরপাল্লার শিপিংয়ের ৫ স্তরের ডাবল ওয়াল শিট", price: 55000, image: "https://images.unsplash.com/photo-1595079676339-1534801ad6cf?w=400&auto=format&fit=crop&q=60" },
      { name: "স্ট্রেচ র‍্যাপ ফিল্ম রোল", specs: "এলএলডিপিই স্ট্রং প্যালেট র‍্যাপিং মোড়ানো ফিল্ম রোল", price: 165000, image: "https://images.unsplash.com/photo-1512909006721-3d6018887383?w=400&auto=format&fit=crop&q=60" },
      ...
      { name: "সেলফ অ্যাডহেসিভ বিওপিপি টেপ", specs: "কার্টন বক্স সিল করার শক্তিশালী আঠালো টেপ রোল", price: 140000, image: "https://images.unsplash.com/photo-1512909006721-3d6018887383?w=400&auto=format&fit=crop&q=60" },
  ...
  Electrical: {
    products: [
      { name: "ডিস্ট্রিবিউশন ট্রান্সফরমার ২৫০kVA", specs: "কারখানার সাবস্টেশনের জন্য ১১kV তেল-নিমজ্জিত ট্রান্সফরমার", price: 420000, image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=400&auto=format&fit=crop&q=60" },
      ...
      { name: "৩-ফেজ টোটাল ক্লোজড মোটর ১৫HP", specs: "শিল্পের ব্লোয়ার, কম্প্রেসার ও পাম্প চালনার জন্য থ্রি-ফেজ ১৫HP মোটর", price: 85000, image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=400&auto=format&fit=crop&q=60" },
      { name: "এনওয়াইওয়াই ক্যাবল ৪-কোর ১৬rm", specs: "কারখানার অভ্যন্তরীণ সংযোগের ভারী কপার পাওয়ার ক্যাবল", price: 1850, image: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=400&auto=format&fit=crop&q=60" },
      { name: "ডিস্ট্রিবিউশন ট্রান্সফরমার ৫০০kVA", specs: "মাঝারি থেকে বৃহৎ কারখানার সাবস্টেশনের জন্য ৫০০kVA ট্রান্সফরমার", price: 650000, image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=400&auto=format&fit=crop&q=60" },
      ...
      { name: "পিএফআই প্ল্যান্ট প্যানেল ১০০kVAR", specs: "বিদ্যুৎ বিল কমাতে ক্যাপাসিটর ব্যাংক পাওয়ার ফ্যাক্টর উন্নত প্যানেল", price: 220000, image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=400&auto=format&fit=crop&q=60" },
      { name: "বিওয়াইএ ক্যাবল সিঙ্গেল কোর ২.৫rm", specs: "কারখানার লাইটিং ও ওয়্যারিংয়ের সাধারণ পিভিসি তামার তার", price: 45, image: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=400&auto=format&fit=crop&q=60" },
      { name: "বিওয়াইএ ক্যাবল সিঙ্গেল কোর ৪.০rm", specs: "ভারী পাওয়ার প্লাগ লাইনের জন্য ৪.০rm পিভিসি কপার ক্যাবল", price: 68, image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=400&auto=format&fit=crop&q=60" },
